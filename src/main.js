...
import { UserInterface } from "./module/interface";
import { ShipPlacement } from "./module/shipPlace";
import { ShipStatus } from "./module/status";
...
export const Game = (function () {
    ...
    function displayAttackResult(row, col) {
